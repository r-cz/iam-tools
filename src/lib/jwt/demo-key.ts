...
export const DEMO_PUBLIC_KEY = Object.freeze({
  e: 'AQAB',
  kty: 'RSA',
...
export const DEMO_PRIVATE_KEY = Object.freeze({
  ...DEMO_PUBLIC_KEY,
 ...
 */
export const DEMO_JWKS = Object.freeze({ keys: Object.freeze([DEMO_PUBLIC_KEY]) })
