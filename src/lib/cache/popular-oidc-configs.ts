...
export const popularOidcConfigs: PopularProvider[] = [
  ...
  {
    name: 'Okta (dev-133337)',
    url: 'https://dev-133337.okta.com',
    config: {
      issuer: 'https://dev-133337.okta.com',
      authorization_endpoint: 'https://dev-133337.okta.com/oauth2/v1/authorize',
      token_endpoint: 'https://dev-133337.okta.com/oauth2/v1/token',
      userinfo_endpoint: 'https://dev-133337.okta.com/oauth2/v1/userinfo',
      jwks_uri: 'https://dev-133337.okta.com/oauth2/v1/keys',
      registration_endpoint: 'https://dev-133337.okta.com/oauth2/v1/clients',
  ...
  },
  {
    ...
    config: {
      ...
      authorization_endpoint: 'https://token.actions.githubusercontent.com/oauth/authorize',
      token_endpoint: 'https://token.actions.githubusercontent.com/oauth/token',
      ...
      claims_supported: ['aud', 'exp', 'iat', 'iss', 'jti', 'nbf', 'sub', 'actor', 'actor_id', 'base_ref', 'event_name', 'head_ref', 'job_workflow_ref', 'ref', 'ref_type', 'repository', 'repository_id', 'repository_owner', 'repository_owner_id', 'run_id', 'run_number', 'run_attempt', 'runner_environment', 'workflow', 'workflow_ref'],
    }
  },
  {
    name: 'Apple',
