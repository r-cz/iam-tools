      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
          <div className="p-3">
            ...
            <p className="text-2xl font-bold">{formatTimeDiff(issuedAt, now)}</p>
            <p
        ...
        {authTime && (
          <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
            <div className="p-3">
              ...
              <p className="text-lg font-bold">{formatTimeDiff(authTime, now)} ago</p>
              <p
                className="text-xs text-muted-foreground truncate"
        ...
        <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
          <div className="p-3">
            ...
            <p className="text-lg font-bold">{formatTimeDiff(issuedAt, expiration)}</p>
