  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Discovered from:{' '}
          <code className="text-xs">{config.issuer}/.well-known/openid-configuration</code>
        </CardDescription>
      </CardHeader>
      ...
      <CardContent>
        ...
        >
                      ...
                      if (key === 'jwks_uri') {
                        return (
                          <div key={key} className="py-3 first:pt-0 last:pb-0">
                            <div className="flex flex-wrap justify-between gap-2 mb-1">
                              <div className="flex items-start gap-2">
                                ...
                                <h4 className="font-medium break-words">
                                  ...
                                  {endpointDescriptions[key]?.required && (
                            ...
                            {getEndpointDescription(key) && (
                              <div className="mb-2">{getEndpointDescription(key)}</div>
                            )}
          ...
          <TabsContent value="raw">
            <JsonDisplay data={config} containerClassName="relative" maxHeight="70vh" />
          </TabsContent>
        </Tabs>
      </CardContent>
      ...
      <CardFooter className="flex justify-between border-t pt-6">
        <p className="text-xs text-muted-foreground">
          Required fields for OpenID Connect providers are marked with{' '}
