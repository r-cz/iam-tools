...
export const endpointDescriptions: { [key: string]: EndpointDescription } = {
  issuer: {
    name: 'Issuer',
    description: 'The identifier for the OIDC provider. This is a URL that the provider asserts as its identifier.',
    required: true,
    specification: 'OpenID Connect Core 1.0, Section 3.1.2.2',
  },
  authorization_endpoint: {
    name: 'Authorization Endpoint',
    description: 'The URL of the authorization server\'s authorization endpoint. Used to authenticate the end-user.',
    required: true,
    specification: 'OpenID Connect Core 1.0, Section 3.1.2.1',
  },
  token_endpoint: {
    name: 'Token Endpoint',
    description: 'The URL of the authorization server\'s token endpoint. Used to exchange authorization codes for tokens.',
    required: true,
    specification: 'OpenID Connect Core 1.0, Section 3.1.3.1',
  },
  userinfo_endpoint: {
    name: 'UserInfo Endpoint',
    description: 'The URL of the authorization server\'s UserInfo endpoint. Used to obtain claims about the authenticated user.',
    required: false,
    specification: 'OpenID Connect Core 1.0, Section 5.3',
  },
  jwks_uri: {
    name: 'JWKS URI',
    description: 'The URL of the authorization server\'s JSON Web Key Set. Contains the public keys used to verify tokens.',
    required: true,
  ...
  revocation_endpoint: {
    ...
    description: 'The URL of the authorization server\'s revocation endpoint. Used to revoke access tokens and refresh tokens.',
    required: false,
    specification: 'OAuth 2.0 Token Revocation, RFC 7009',
  },
  introspection_endpoint: {
    name: 'Introspection Endpoint',
    description: 'The URL of the authorization server\'s introspection endpoint. Used to query the state of an access or refresh token.',
    required: false,
  ...
  request_parameter_supported: {
    ...
    description: 'Boolean value indicating whether the authorization server supports the use of the request parameter.',
    required: false,
    specification: 'OpenID Connect Core 1.0, Section 6',
  },
  request_uri_parameter_supported: {
    name: 'Request URI Parameter Supported',
    description: 'Boolean value indicating whether the authorization server supports the use of the request_uri parameter.',
    required: false,
    specification: 'OpenID Connect Core 1.0, Section 6',
  },
};
