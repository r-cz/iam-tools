...
export const providerInfoData: { [key: string]: ProviderInfo } = {
  ...
  'Salesforce': {
    name: 'Salesforce',
    description: 'Salesforce Identity provides identity management tools for Salesforce customers and partners.',
  ...
  'ForgeRock': {
    name: 'ForgeRock',
    description: 'ForgeRock provides identity and access management solutions for Internet of Things and customer-facing applications.',
