  ...
  return (
    <div className="container py-10">
      <Card className="w-full max-w-3xl mx-auto">
        <CardHeader>
          <CardTitle>{code ? 'Authorization Successful' : 'Authorization Failed'}</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          {code ? (
            <>
              ...
              <p className="text-muted-foreground text-sm">
                The authorization code has been received. Click continue to proceed to the token
                exchange step.
              </p>
            </>
          ) : (
            <>
              ...
              <p className="text-muted-foreground text-sm">
                The authorization request failed. Click continue to return to the OAuth Playground
                and try again.
              </p>
            </>
          )}
          ...
          <div className="flex justify-end">
            <Button onClick={handleContinue}>Continue to OAuth Playground</Button>
          </div>
        </CardContent>
      </Card>
    </div>
